...
-- Migrate legacy Modalities field to InputModalities/OutputModalities if needed
-- This is typically handled by the application layer, but included for completeness:
-- UPDATE llm_models
-- SET input_modalities = modalities,
--     output_modalities = modalities
-- WHERE modalities IS NOT NULL
--   AND (input_modalities IS NULL OR input_modalities = '[]');
